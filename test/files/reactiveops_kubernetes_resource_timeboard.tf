resource "datadog_timeboard" "reactiveops_kubernetes_resource_timeboard" {
  title       = "[reactiveops] Kubernetes Resource Timeboard"
  description = "[reactiveops] Kubernetes Resource Timeboard"
  read_only   = false
